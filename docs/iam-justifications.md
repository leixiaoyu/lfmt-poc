...
Resources: [`arn:aws:secretsmanager:${region}:${account}:secret:lfmt/gemini-api-key-${stackName}`];
```
...
Resources: [`arn:aws:lambda:${region}:${account}:function:lfmt-translate-chunk-${stackName}`];
```
